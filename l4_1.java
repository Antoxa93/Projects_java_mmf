...
public class l4_1 {
    public static class Polynome{
        public static class Polynomial {
            ...
            Polynomial(Double... aegsArray) {
                size = aegsArray.length;
                coefficients = new double[size];

                for (int i = 0; i < size; i++) {
                    coefficients[i] = aegsArray[size - 1 - i];
                }
            }
            ...
            public static Polynomial add(Polynomial p1, Polynomial p2){
                ...
                for (int i = 0; i < max_len; i++){
                    if (i < p1.size){
                        new_poly.coefficients[i] += p1.coefficients[i];
                    }
                    if (i < p2.size){
                        new_poly.coefficients[i] += p2.coefficients[i];
                    }
                }
                return new_poly;
            }
        ...
        public static Polynomial sumPolys(Polynomial[] polynomials){
            int polyAmount = polynomials.length;
        ...
        public static  void testPolysAddition(){
            ...
            Polynomial poly_3 = new Polynomial(-5.0, 11.0, 5.0, 5.5, 2.2, 0.0, -6.6, 1.0);
